...
def main():
    ...
    train_config = "train_configs/safebench-tiny_jailbroken_mode_full50.csv"  # EXACT-DIFF: was ./train_configs/test.csv
    ...
    exp_name = 'codefaithful_exact_1300'  # EXACT-DIFF: was 'test'
    base_epoch = 0
    ...
    # Training loop
    num_epochs = 1301  # EXACT-DIFF: was 5000 (epochs 0..1300 -> 1300.png; Table 4 = 1300 iters)
